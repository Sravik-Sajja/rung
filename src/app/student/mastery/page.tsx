...
export default function MasteryPage() {
  ...
  useEffect(() => {
    fetch(`/api/students/${canonicalDemoIds.mayaStudentId}/mastery?topicId=${canonicalDemoIds.fractionsTopicId}`)
